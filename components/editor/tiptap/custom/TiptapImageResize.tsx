...
import { type CSSProperties, useCallback, useEffect, useLayoutEffect, useRef, useState, RefObject } from 'react';
import { NodeViewProps } from '@tiptap/react';

interface NodeViewCustomProps extends NodeViewProps {
...
function TiptapImageResize({ node, updateAttributes, editing, setEditing, containerRef }: NodeViewCustomProps) {
